 ...
 <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>RestauLav</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Developed by <a href="https://facebook.com/atutechscorp">Atutechs Corp using Laravel 7.x</a>
      </div>
    </div>
  </footer><!-- End Footer -->
