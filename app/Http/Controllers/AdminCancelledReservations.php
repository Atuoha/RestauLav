...
class AdminCancelledReservations extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('accounts.admin.reservations.cancelled', compact('reservations'));
    }
    ...
    public function retrieve_cancelled($id){
       ...
       $reserve = Reservation::withTrashed()->findOrFail($id);
       $reserve->restore();
       Session::flash('RESERVATION_RETRIEVE', 'Reservation for '.$reserve->table_number .' has been retrieved');
    ...
    public function terminate_cancelled($id){
        ...
        $reserve = Reservation::withTrashed()->findOrFail($id);
       Session::flash('RESERVATION_DELETE', 'Reservation for '.$reserve->table_number .' has been terminated permanently');
       $reserve->forceDelete();
